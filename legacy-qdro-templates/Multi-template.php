...
<style>
	...
	<p style="text-indent: 3em;">This has come before the Court based upon a Decree of Divorce entered <?php echo esc_html($divorce_date); ?>, and the submission of this <?php if (!empty($amended_text)) echo esc_html($amended_text) . ' '; ?>Qualified Domestic Relations Order. The Court having reviewed the file and it appearing there is no just reason for delay, and for good cause appearing, does now make the following Qualified Domestic Relations Order:</p>

	<p style="text-indent: 3em;">WHEREAS, this Court has continuing jurisdiction over the parties and the subject matter of this Order; and</p>
	
	<p style="text-indent: 3em;">
		WHEREAS, this Court has continuing jurisdiction over the parties and the subject matter of this Order; and
	</p>
	<p style="text-indent: 3em;">
				WHEREAS, the parties and the Court intend that this Order shall be a Qualified Domestic Relations Order (hereinafter referred to as “QDRO”) as defined in Section 206(d)(3) of the Employee Retirement Income Security Act of 1974, as amended (“ERISA”) and Section 414(p) of the Internal Revenue Code of 1986, as amended; and,
	</p>
	<p style="text-indent: 3em;">
		WHEREAS, pursuant to the referenced statues, the Plan Administrator shall make a determination of the qualified status of this Order; and
	</p>
	<p style="text-indent: 3em;">
		WHEREAS, following approval by the Plan Administrator, this order shall constitute a Qualified Domestic Relations Order; and 
	</p>
	<p style="text-indent: 3em;">
		WHEREAS, the parties have stipulated that the Court enter this Order;
	</p>
	<p style="text-indent: 3em;">
		NOW, THEREFORE, pursuant to this state’s Domestic Relations Laws, IT IS HEREBY
	</p>

	<p>ORDERED BY THE COURT as follows:</p>

	<p style="text-indent: 3em;">1.	As used in this Order, the following terms shall apply:</p>
	<p style="text-indent: 6em;">(a)	“Participant” shall mean <?php echo esc_html( $owner_first_name . ' ' . $owner_last_name ); ?>, whose current address is <?php echo esc_html($owner_full_address); ?>; SSN <?php echo esc_html($owner_ssn); ?>; DOB <?php echo esc_html($owner_dob); ?>; Phone <?php echo esc_html($owner_phone); ?>; Email <?php echo esc_html($owner_email); ?></p>
	<p style="text-indent: 6em;">(b)	“Alternate Payee” shall mean <?php echo esc_html( $receiver_first_name . ' ' . $receiver_last_name ); ?>, whose current address is <?php echo esc_html($receiver_full_address); ?>; SSN <?php echo esc_html($receiver_ssn); ?>; DOB <?php echo esc_html($receiver_dob); ?>; Phone <?php echo esc_html($receiver_phone); ?>; Email <?php echo esc_html($receiver_email); ?></p>
	<p style="text-indent: 6em;">(c)	“Plan” shall mean <?php echo esc_html($formal_plan_name); ?> (“Plan”).</p>
	<p style="text-indent: 3em;">2. The Order relates to marital property rights.</p>
	<p style="text-indent: 3em;">3. The date of marriage was <?php echo esc_html ($marriage_date); ?>.</p>
	<p style="text-indent: 3em;">4. The date of divorce was <?php echo esc_html($divorce_date); ?>.</p>
	<p style="text-indent: 3em;">5. The Alternate Payee is the former spouse of the Participant.</p>
	<p style="text-indent: 3em;">6. With respect to marital property, alimony or spousal support awards, the Participant and the Alternate Payee are/were considered married for federal income tax purposes.	</p>
	<p style="text-indent: 3em;">7. The “Valuation Date” shall be <?php 
		if (empty($field_29_raw) && empty($field_34_raw)) {
