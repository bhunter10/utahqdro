<?php
/**
 * Template Name: DMBA Pension Template
 * Version: 1.0
...
<style>
    ...
    <table class="case-info-table">
        <tr>
            ...
            <td style="padding:20px 0 20px 20px; width:50%;">
                ...
                Re: Deseret Mutual Master Retirement Plan (Pension)<br><br>
	...
	<p>1.	A judgment, decree or order providing for marital property rights to <?php echo esc_html( $owner_first_name . ' ' . $owner_last_name ); ?>’s former spouse has been previously entered in this matter pursuant to state domestic relations laws.</p>
	...
	<p style="text-align:center"><strong>II. STATEMENT OF FACTS PURSUANT TO CODE §414(p)/ERISA §206(d)</strong></p>
	...
	<p>6.	<?php echo esc_html( $owner_first_name . ' ' . $owner_last_name ); ?> (“Participant”) is a participant in the Plan(s).  Participant’s information is as follows:</p>
	...
	<p>7.	<?php echo esc_html($receiver_first_name . ' ' . $receiver_last_name); ?> (“Alternate Payee”) is the alternate payee for purposes of this QDRO.  Alternate Payee’s Information is as follows:</p>
	...
	<p>8.   The Participant’s Deseret Mutual Master Retirement Plan benefit payable to the Alternate Payee under this QDRO is <?php echo ($division_type === 'fixed') ? '50%' : esc_html($percent_amount); ?> of all benefits accrued in the Plan by Participant from <?php echo($marriage_date); ?> to <?php echo($divorce_date); ?>.
	</p>
	...
	<p style="text-align:center;"><strong>III. RECITALS PURSUANT TO CODE §414(p)(3)/ERISA §206(d)(3)(D)</strong></p>
	...
	<p style="text-align:center;"><strong>IV. TIME AND MANNER OF PAYMENT</strong></p>
	...
	<p style="text-align:center"><strong>V. PROCEDURE FOR PROCESSING THIS QDRO</strong></p>
