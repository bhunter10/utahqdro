<?php
/**
 * Template Name: T.RowPrice IHC - 401k
 * Version: 1.0
...
<style>
	...
	<table class="case-info-table">
		<tr>
			...
			<td style="padding:20px 0 20px 20px; width:50%;">
				...
				Re: T.Rowe Price IHC 401k<br><br>
	...
	<p style="padding-left: 5em;">
		b.	With respect to any distribution from the Plan to the Alternate Payee, the Alternate Payee shall provide such requests for payment, elections and consents to payment and receipts of payment as the Plan’s Administrator  may require.  The transfer from the Participant’s Account to the Account established for distribution to the Alternate Payee shall be made in the following manner:  The Plan’s Administrator shall transfer to the account of the Alternate Payee <?php echo esc_html($display_amount); ?> of the Participant’s Account.  
	</p>
	...
	<p style="padding-left: 5em;">
		...
		<div style="padding-left:7em;">
			...
			if (!$has_employer_info) {
				...
				echo 'Murray, UT 84123<br>';
				echo 'Submit Certified QDRO c/o QDRO Consultants<br>';
				echo 'https://qdros.com/submit/';
			} else {
				...
				if (!empty($employer_email)) echo 'Email: ' . esc_html($employer_email) . '<br>';
			}
			?>
		</div>
	</p>
